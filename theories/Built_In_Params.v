...
Definition sig_aspargs : ASP_ARGS := JSON__Object [].
...
Definition check_nonce_aspargs : ASP_ARGS := JSON__Object [].
...
Definition hsh_aspargs : ASP_ARGS := JSON__Object []. 
...
Definition enc_aspargs : ASP_ARGS := JSON__Object [].
